  ...
  return (
    <box className="StyleBox">
      <box className="Footer">
        ...
        <p>created by Guilherme Junque</p>
        <img
          className="Image"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMry40xb9-uQ56otkqgfF9ax5NrB0g8V2B6w&usqp=CAU"
          alt="Guilherme Junque"
        />
      </box>
    </box>
  );
